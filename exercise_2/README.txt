...
3. To capture tweets and write to a database, please follow the below steps.
...
4. To look at the count of words for a particular word, execute the below command from the exercise_2 directory

python finalresults.py <word>

5. To look at all word counts, execute the below command from the exercise_2 directory

python finalresults.py

6. To get an ordered list of all word counts (histogram) between two given counts, execute the below command from the exercise_2 directory
